...
class PostApi {
    ...
    // Liken
    func incrementLikes(postId id: String, onSuccess: @escaping (PostModel) -> Void, onError: @escaping (_ errorMessage: String?) -> Void) {
    ...
    // Posts laden und nach likes sortieren
